...
# Path of this script: C:\repo\my_project\5_my_work\1_LED_control\led_control_app_system\_ide\scripts\debugger_led_control_app-default.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source C:\repo\my_project\5_my_work\1_LED_control\led_control_app_system\_ide\scripts\debugger_led_control_app-default.tcl
# 
connect -url tcp:127.0.0.1:3121
targets -set -nocase -filter {name =~"APU*"}
rst -system
after 3000
targets -set -filter {jtag_cable_name =~ "Digilent Zybo Z7 210351BD24D5A" && level==0 && jtag_device_ctx=="jsn-Zybo Z7-210351BD24D5A-23727093-0"}
